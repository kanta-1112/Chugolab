...
data_path = r"C:\\study\\Prac_Programming\\prac_Python\\Chugolab\\2DKDE_data\\prog_data25.csv"
...
# グリッドポイントの作成
# x軸とy軸にそれぞれどれだけの細かさで評価するかを指定します。
...
# 画像を表示する
# extent=[xmin, xmax, ymin, ymax]で画像の表示範囲を指定
...
# 等高線図で密度をプロット
plt.contourf(xi, yi, density1, levels=10, cmap='Reds', alpha=0.7)
plt.contourf(xi, yi, density2, levels=10, cmap='Blues', alpha=0.7)
