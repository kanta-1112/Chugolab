...
# ---------------------------------------------------------
#実装内容：異なる足首角度の初期条件a(0°,10°,20°)ごとに画像データを生成
...
BASE_DIR = r"C:\study\Prac_Programming\prac_Python\Chugolab\2DKDE_data"
OUT_DIR = r"C:\study\Prac_Programming\prac_Python\Chugolab\2DKDE_png\20251106"
